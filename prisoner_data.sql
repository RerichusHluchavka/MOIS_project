...
INSERT INTO public.cells (cell_id, cell_name)
VALUES (1, 'A'),
       (2, 'B'),
       (3, 'C'),
       (4, 'D'),
...
INSERT INTO public.prisoner_allergens (prisoner_id, allergen_id, severity)
VALUES (1, 1, 'Medium'),
       (2, 1, 'Low'),
       (3, 1, 'High'),
       (4, 1, 'Medium'),
...
--
-- COPY used \N for NULL; here it's SQL NULL

INSERT INTO public.prisoners (prisoner_id, first_name, last_name, credits, cell_id, entry_date, release_date,
                              danger_level, religion)
VALUES (1, 'John', 'Smith', 120, 1, '2025-12-09', NULL, 3, 'Christian'),
       (2, 'Mike', 'Brown', 80, 2, '2025-12-09', NULL, 2, 'Atheist'),
       (3, 'Ahmed', 'Ali', 200, 3, '2025-12-09', NULL, 4, 'Muslim'),
       (4, 'David', 'Clark', 50, 4, '2025-12-09', NULL, 1, 'Jewish'),
       (5, 'Lukas', 'Novak', 30, 5, '2025-12-09', NULL, 5, 'Atheist'),
       (6, 'Peter', 'White', 75, 6, '2025-12-09', NULL, 2, 'Christian'),
       (7, 'Karel', 'Dvorak', 90, 1, '2025-12-09', NULL, 3, 'Atheist'),
       (8, 'Marek', 'Svoboda', 110, 2, '2025-12-09', NULL, 4, 'Christian'),
       (9, 'Tomas', 'Král', 60, 3, '2025-12-09', NULL, 2, 'Christian'),
       (10, 'Roman', 'Horak', 45, 4, '2025-12-09', NULL, 1, 'Atheist'),
       (11, 'Ali', 'Hassan', 150, 5, '2025-12-09', NULL, 4, 'Muslim'),
       (12, 'Omar', 'Farouk', 210, 6, '2025-12-09', NULL, 5, 'Muslim'),
       (13, 'Jan', 'Prochazka', 20, 1, '2025-12-09', NULL, 1, 'Christian'),
       (14, 'Martin', 'Kolar', 55, 2, '2025-12-09', NULL, 2, 'Atheist'),
       (15, 'Ondrej', 'Blaha', 85, 3, '2025-12-09', NULL, 3, 'Christian'),
       (16, 'Radek', 'Urban', 130, 4, '2025-12-09', NULL, 4, 'Atheist'),
       (17, 'Ivan', 'Petrov', 170, 5, '2025-12-09', NULL, 5, 'Orthodox'),
       (18, 'Sergey', 'Ivanov', 190, 6, '2025-12-09', NULL, 4, 'Orthodox'),
       (19, 'Adam', 'Green', 65, 1, '2025-12-09', NULL, 2, 'Jewish'),
       (20, 'Noah', 'Levi', 140, 2, '2025-12-09', NULL, 3, 'Jewish'),
       (21, 'Ethan', 'Cohen', 90, 3, '2025-12-09', NULL, 2, 'Jewish'),
       (22, 'Samuel', 'Gold', 110, 4, '2025-12-09', NULL, 3, 'Jewish'),
       (23, 'Mohammed', 'Saleh', 220, 5, '2025-12-09', NULL, 5, 'Muslim'),
       (24, 'Yusuf', 'Khan', 175, 6, '2025-12-09', NULL, 4, 'Muslim'),
       (25, 'Pavel', 'Maly', 40, 1, '2025-12-09', NULL, 1, 'Atheist'),
       (26, 'Jiri', 'Sedlak', 70, 2, '2025-12-09', NULL, 2, 'Christian'),
       (27, 'Vaclav', 'Fiala', 95, 3, '2025-12-09', NULL, 3, 'Christian'),
       (28, 'Zdenek', 'Koubek', 160, 4, '2025-12-09', NULL, 5, 'Atheist'),
       (29, 'Daniel', 'King', 85, 5, '2025-12-09', NULL, 2, 'Christian'),
       (30, 'Robert', 'Hill', 100, 6, '2025-12-09', NULL, 3, 'Christian'),
       (31, 'Chris', 'Moore', 60, 1, '2025-12-09', NULL, 2, 'Atheist'),
       (32, 'Brian', 'Taylor', 45, 2, '2025-12-09', NULL, 1, 'Atheist'),
       (33, 'Leon', 'Schmidt', 130, 3, '2025-12-09', NULL, 4, 'Christian'),
       (34, 'Hans', 'Weber', 155, 4, '2025-12-09', NULL, 4, 'Christian'),
       (35, 'Karl', 'Muller', 90, 5, '2025-12-09', NULL, 3, 'Christian'),
       (36, 'Kevin', 'Young', 70, 6, '2025-12-09', NULL, 2, 'Atheist'),
       (37, 'Jason', 'Adams', 65, 1, '2025-12-09', NULL, 1, 'Atheist'),
       (38, 'Eric', 'Baker', 115, 2, '2025-12-09', NULL, 3, 'Christian'),
       (39, 'Ben', 'Walker', 95, 3, '2025-12-09', NULL, 2, 'Christian'),
       (40, 'Luke', 'Scott', 125, 4, '2025-12-09', NULL, 3, 'Christian'),
       (41, 'Aaron', 'Perez', 150, 5, '2025-12-09', NULL, 4, 'Jewish'),
       (42, 'Jose', 'Garcia', 180, 6, '2025-12-09', NULL, 4, 'Catholic');
...
ALTER TABLE ONLY public.prisoner_allergens
    ADD CONSTRAINT prisoner_allergens_allergen_id_fkey FOREIGN KEY (allergen_id) REFERENCES public.allergens(allergen_id) ON
UPDATE CASCADE
ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.prisoner_allergens
    ADD CONSTRAINT prisoner_allergens_prisoner_id_fkey FOREIGN KEY (prisoner_id) REFERENCES public.prisoners(prisoner_id) ON
UPDATE CASCADE
ON
DELETE CASCADE;
...
ALTER TABLE ONLY public.prisoners
    ADD CONSTRAINT prisoners_cell_id_fkey FOREIGN KEY (cell_id) REFERENCES public.cells(cell_id) ON
UPDATE CASCADE
ON
DELETE RESTRICT;
